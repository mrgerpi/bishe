...
var AddServiceRequest_Ip_DEFAULT string

func (p *AddServiceRequest) GetIp() string {
	if !p.IsSetIp() {
		return AddServiceRequest_Ip_DEFAULT
	}
	return *p.Ip
}
func (p *AddServiceRequest) IsSetIp() bool {
	return p.Ip != nil
}
...
func (p *AddServiceRequest) ReadField8(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
...
func (p *AddServiceRequest) writeField8(oprot thrift.TProtocol) (err error) {
	if p.IsSetIp() {
		if err := oprot.WriteFieldBegin("ip", thrift.STRING, 8); err != nil {
			return fmt.Errorf("%T write field begin error 8:ip: %s", p, err)
		}
		if err := oprot.WriteString(string(*p.Ip)); err != nil {
			return fmt.Errorf("%T.ip (8) field write error: %s", p, err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return fmt.Errorf("%T write field end error 8:ip: %s", p, err)
		}
	}
	return err
}
