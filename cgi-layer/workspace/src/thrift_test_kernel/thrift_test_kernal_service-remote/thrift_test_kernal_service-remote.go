...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  GetServiceListResponse GetServiceList(GetServiceListRequest request)")
	fmt.Fprintln(os.Stderr, "  AddServiceResponse AddService(AddServiceRequest request)")
	fmt.Fprintln(os.Stderr, "  FillDataResponse FillData(FillDataRequest request)")
	fmt.Fprintln(os.Stderr, "  RequestTriggerResponse RequestTrigger(RequestTriggerRequest request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := thrift_test_kernel.NewThriftTestKernalServiceClientFactory(trans, protocolFactory)
	...
	case "GetServiceList":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "GetServiceList requires 1 args")
			flag.Usage()
		}
		arg11 := flag.Arg(1)
		...
		argvalue0 := thrift_test_kernel.NewGetServiceListRequest()
		...
		value0 := argvalue0
		fmt.Print(client.GetServiceList(value0))
		fmt.Print("\n")
		break
	case "AddService":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := thrift_test_kernel.NewAddServiceRequest()
	...
	case "FillData":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "FillData requires 1 args")
			flag.Usage()
		}
		arg23 := flag.Arg(1)
		...
		argvalue0 := thrift_test_kernel.NewFillDataRequest()
		...
		value0 := argvalue0
		fmt.Print(client.FillData(value0))
		fmt.Print("\n")
		break
	case "RequestTrigger":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "RequestTrigger requires 1 args")
			flag.Usage()
		}
		arg29 := flag.Arg(1)
		...
		argvalue0 := thrift_test_kernel.NewRequestTriggerRequest()
		...
		value0 := argvalue0
		fmt.Print(client.RequestTrigger(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
